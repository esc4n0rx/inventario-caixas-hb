...
export default function Contagens() {
  ...
  const [lojaFilter, setLojaFilter] = useState("todas"); // Usando "todas" em vez de string vazia
          ...
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                size="sm"
                onClick={exportToCSV}
                disabled={isExporting || contagens.length === 0}
              ...
              <div className="w-64">
                <Select value={lojaFilter} onValueChange={setLojaFilter}>
                  ...
                  <SelectContent className="bg-zinc-800 border-zinc-700">
                    <SelectItem value="todas">Todas as lojas</SelectItem> {/* Mudamos para "todas" em vez de string vazia */}
                    {lojas.map((loja) => (
